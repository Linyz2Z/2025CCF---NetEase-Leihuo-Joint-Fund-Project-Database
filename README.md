...
- **LLM嵌入向量**：对大语言模型候选集进行可学习的向量化建模，用于表示各模型的能力特征。
...
## 技术方案
本项目的详细技术设计文档位于 [`docs/design.md`](./docs/design.md)，包含问题定义、技术路线等说明。
...
### 4. 结果
在 [`code/test_results/`](.code/test_results/) 文件夹中查看对应的csv结果文件。
...
### 测试数据
[`code/test_data/demo_test_pred.csv`](./code/test_data/demo_test_pred.csv)
